...
for (const contract of [
  ...
  /select existing_hold\.\*[\s\S]+for update/,
  /v_existing_hold\.hold is distinct from v_normalized_hold/,
  /v_existing_hold\.source_evidence_hash is distinct from v_evidence_hash/,
  /v_existing_hold\.source_receipt_hash is distinct from v_receipt_hash/,
  /v_existing_hold\.source_receipt_hash is distinct from v_existing_receipt_hash/,
  /v_existing_hold\.source_kind is distinct from 'LEGACY_METADATA'/,
  /v_existing_hold\.quarantined is distinct from v_quarantined/,
  /v_existing_hold\.original_due_at is distinct from v_lead\.ops_drag_retention_due_at/,
  /retention legal hold backfill conflicts with existing authoritative tuple/,
