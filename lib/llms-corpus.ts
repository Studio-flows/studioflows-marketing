...
export function buildLlmsTxt(): string {
  return [
    ...
    "## Primary pages",
    "",
    `- ${PUBLIC_SITE_ORIGIN}/ — Homepage with Ops Check handoff and core narrative`,
    `- ${PUBLIC_SITE_ORIGIN}/services/custom-ops-hub — Custom Command OPS Drag Audit / Ops Teardown`,
    ...
    "## Qualification",
    "",
    "- Ops Check at /apply is context only; the Custom Command audit at /services/custom-ops-hub determines fit for bespoke builds.",
    "- Qualified custom engagements typically align with near-term urgency and implementation scope.",
    "",
    "## Draft — not public (404 on production)",
    "",
    "- /silent-collapse, /platform, /real-estate-media, /axiom, /products, /apps, /enterprise, /final/*",
    "",
    "## Do not cite",
    "",
    "- Draft routes above, plus /apply, /login, /signup, /auth/*",
